        ...
        <div className='flex justify-center items-center py-5 w-full '>
          <div className='w-80'>
            <form action="flex flex-col">
              ...
              <div className='flex flex-col gap-3'>
                <button type='submit' className='bg-[#208F1D] py-3 rounded text-white text-left px-3 font-medium flex justify-between hover:bg-[#329629] transition-all'>Confirmar <MoveRight /></button>
              </div>
            </form>
          </div>
          <div className=''>
